...
var MongoDBManager = (function () {
    function MongoDBManager() {
        this.connectUrl = 'mongodb+srv://rug4ru:rug4ru31415@cluster0.xil3n.mongodb.net/test?retryWrites=true&w=majority';
        this.client = new mongodb_1.MongoClient(this.connectUrl);
        this.dbName = String();
        this.isConnectionOpened = Boolean();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.ensureCollectionExists(collectionName)];
                    case 2:
                        _a.sent();
                        db = this.client.db(this.dbName);
                        collection = db.collection(collectionName);
                    ...
                    case 5:
                        e_1 = _a.sent();
                        e_1 instanceof Error ? console.error(e_1.message) : console.error(e_1);
                        throw e_1;
                    case 6: return [2];
                }
            });
    ...
    MongoDBManager.prototype.updateById = function (id, dataToUpdate, collectionName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.getCollection(collectionName)];
                    case 1:
                        collection = _a.sent();
    ...
    MongoDBManager.prototype.getCollection = function (collectionName) {
        return __awaiter(this, void 0, void 0, function () {
            var db;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        db = this.client.db(this.dbName);
                        return [2, db.collection(collectionName)];
                }
            });
        });
    };
    MongoDBManager.prototype.openConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.isConnectionOpened) return [3, 2];
    ...
    MongoDBManager.prototype.ensureCollectionExists = function (collectionName) {
        var _this = this;
        return new Promise(function (resolve) {
            ...
            db.listCollections({ name: collectionName })
                ...
                if (!collInfo) {
                    db.createCollection(collectionName).then(function () { resolve(); });
                }
                resolve();
            });
        });
